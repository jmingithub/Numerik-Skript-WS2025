...
gelte $\phi < 2 \psi(t)$ in $(t_0, t_0+ \epsilon), \epsilon > 0$. Dann gilt entweder
\begin{enumerate}
...
Die Reihe konvergiert absolut und gleichmäßig auf jedem kompakten Intervall von $\mathbb{R}$ gegen $e^{tA}$
