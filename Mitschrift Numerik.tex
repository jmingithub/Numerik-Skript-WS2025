...
Falls $||y_0-u_0|| \to 0$ konvergiert, dann gilt $\underset{t_n \in I}{\max} ||y_n - u(t_n)||$ für $h \to 0$ und für genügend kleines $h < \frac{1}{2}L^{-1}$ gilt die Fehlerabschätzung $||y_n-u(t_n)|| \leq e^{4L(t_n-t_0)} (||y_0-u_0|| + \sum_{\nu=1}^n h_\nu ||\tau_\nu||), 0 \leq n \leq N$. Für eine explizite Methode kann die Schrittweitenbedingung entfallen. \\
\textbf{Beweis:} \\
