...
Falls keine Missverständnisse entstehen, schreiben wir im Folgenden auch $y_n$ für $y_n^h$ und $\tau_n = \tau_n^h$. Dann gilt $u_n = u_{n-1} + h_n f(t_{n-1}, u_{n-1}) + h_n \tau_n$. Die Abschätzung des globalen Diskretisierungsfehlers $e_n = y_n - u_n$ erfolgt über einen sogenannten Stabilitätssatz für Differenzenverfahren. \\
