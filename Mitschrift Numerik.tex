...
Was wir uns für die Klausur nochmal anschauen sollten(kommt nicht garantiert genau so dran, nur sehr wahrscheinlich: "Bitte noch einmal gut üben")(ein erster Teil, Donnerstag der Rest):

\begin{itemize}
\item Phasenraumanalyse (leichter als auf dem Beispielblatt für Weihnachten)
\item Linearisieren, Stabilität etc.
\item Existenz und Eindeutigkeit für konkrete Probleme
